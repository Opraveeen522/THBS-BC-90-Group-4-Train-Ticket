			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) 
					{
						...
						rd.include(req, res);
						pw.println("<div style='text-align:center; margin-top:0%; font-size:20px; font-weight:800;color:white;' class='main' ><p1 class='menu'>Running Trains</p1></div>");
						pw.println("<div style='text-align:center; margin-top:3%; font-size:15px; font-weight:700;color:#00008B;' class='tab'><table border=1 align=center><tr ><th style='color:yellow;' >Train Name</th><th style='color:yellow;'>Train Number</th>"
								+ "<th style='color:yellow;'>From Station</th><th style='color:yellow;'>To Station</th><th style='color:yellow;'>Seats Available</th><th style='color:yellow;'>Fare (INR)</th></tr>");
						long trainNo;
						String fromStn;
						String toStn;
						do {
						...
						RequestDispatcher rd = req.getRequestDispatcher("ViewTrains.html");
						rd.include(req, res);
						pw.println("<div style='text-align:center; margin-top:3%; font-size:15px; font-weight:700;color:#00008B;'  class='main'><p1 class='menu red'> No Running Trains</p1></div>");
					}
				}
				catch(Exception e) {}
			}
