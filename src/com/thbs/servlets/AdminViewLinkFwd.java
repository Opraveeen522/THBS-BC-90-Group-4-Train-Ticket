			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) {
						...
						rd.include(req, res);
						pw.println("<div style='text-align:center; margin-top:0%; font-size:20px; font-weight:800;color:#00008B;'class='main'><p1 class='menu'>Selected Train Detail</p1></div>");
						pw.println("<div style='text-align:center; margin-top:1.5%; font-size:15px; font-weight:700;color:#00008B;class='tab'>"
								+ "<table border=1 align=center cellpadding=1>"
								+ "<tr  style='color:red;'><td class='blue'>Train Name :</td><td>"+rs.getString("tr_name")+"</td></tr>"
								+ "<tr  style='color:red;'><td class='blue'>Train Number :</td><td>"+rs.getLong("tr_no")+"</td></tr>"
								+ "<tr  style='color:red;'><td class='blue'>From Station :</td><td>"+rs.getString("from_Stn")+"</td></tr>"
								+ "<tr  style='color:red;'><td class='blue'>To Station :</td><td>"+rs.getString("to_Stn")+"</td></tr>"
								+ "<tr  style='color:red;'><td class='blue'>Available Seats:</td><td>"+rs.getLong("available")+"</td></tr>"
								+ "<tr  style='color:red;'><td class='blue'>Fare (INR) :</td><td>"+rs.getLong("fare")+" RS</td></tr>"
								+ "</table>"
								+ "</div>");
					}
					else {
